...
#define SFU_PROTECT_FWALL_CODE_ADDR_START   ((uint32_t) SFU_SENG_ROM_ADDR_START) /*!< Firewall protection CODE area
                                                                                      START address*/
#define SFU_PROTECT_FWALL_CODE_SIZE         ((uint32_t) SFU_SENG_ROM_SIZE)       /*!< Firewall protection CODE area
                                                                                      SIZE*/
#define SFU_PROTECT_FWALL_NVDATA_ADDR_START ((uint32_t)(FLASH_BASE+(FLASH_BANK_SIZE)))/*!< Firewall protection NVDATA
                                                                                           area START address*/
#define SFU_PROTECT_FWALL_NVDATA_SIZE       (SLOT_ACTIVE_1_HEADER + SFU_IMG_IMAGE_OFFSET - \
...
/**
  * @brief  Region 5 - Peripherals and FMC/QUADSPI Area
  */
#define SFU_PROTECT_MPU_AREA_PERIPH_START       ((uint32_t)0x00000000U)
#define SFU_PROTECT_MPU_AREA_PERIPH_SIZE        MPU_REGION_SIZE_4GB        /*!< Entire memory. Areas are defined with subregions. */
...
#define SFU_PROTECT_MPU_AREA_PERIPH_SREG        0xC3U                        /*!< 0x40000000-0xBFFFFFFF : Peripherals,
                                                                                  FMC/QUADSPI banks and registers */
...
/**
  ...
  * From 0x0808 0000 ==> SLOT_ACTIVE_1_START : No execution capability required but no risk as under firewall protection
  */
#define APP_PROTECT_MPU_AREA_ACTIVE_SLOT_START  (SLOT_ACTIVE_1_START / 0x80000U * 0x80000U)
#define APP_PROTECT_MPU_AREA_ACTIVE_SLOT_SIZE   MPU_REGION_SIZE_512KB
#define APP_PROTECT_MPU_AREA_ACTIVE_SLOT_PERM   MPU_REGION_PRIV_RW
#define APP_PROTECT_MPU_AREA_ACTIVE_SLOT_EXEC   MPU_INSTRUCTION_ACCESS_ENABLE
#define APP_PROTECT_MPU_AREA_ACTIVE_SLOT_SREG   0x00U                        /*!< 512 Kbytes */

/**
  * Remove execution capability from 0x080F 4000 ==> 0x080F FFFF with region 7
  */
#define APP_PROTECT_MPU_AREA_HIDE_START         ((uint32_t)0x080F0000U)
#define APP_PROTECT_MPU_AREA_HIDE_SIZE          MPU_REGION_SIZE_64KB
#define APP_PROTECT_MPU_AREA_HIDE_PERM          MPU_REGION_NO_ACCESS
#define APP_PROTECT_MPU_AREA_HIDE_EXEC          MPU_INSTRUCTION_ACCESS_DISABLE
#define APP_PROTECT_MPU_AREA_HIDE_SREG          0x03U                        /*!< 48 Kbytes */
